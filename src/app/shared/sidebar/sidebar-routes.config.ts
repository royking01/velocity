...
export const ROUTES: RouteInfo[] = [
                ...
                { path: '/dashboard/', title: 'Dashboard', icon: 'zmdi zmdi-dot-circle-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },

    
    // {
        
        // path: '/dashboard', title: 'Dashboard', icon: 'zmdi zmdi-view-dashboard', class: 'sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
            ...
            // { path: '/dashboard/logistics', title: 'Dashboard', icon: 'zmdi zmdi-dot-circle-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
        // ]
    // },
    // {
    ...
    {
        path: '', title: 'Users', icon: 'fa fa-database', class: 'sub', badge: '', badgeClass: '', isExternalLink: false,
        submenu: [
            ...
            { path: '/datatable/dispatch', title: 'Dispatch', icon: 'zmdi zmdi-dot-circle-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
            ...
            { path: '/datatable/companies', title: 'Business', icon: 'zmdi zmdi-dot-circle-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
          ]
    },
                { path: '/dashboard/orders', title: 'Orders', icon: 'zmdi zmdi-dot-circle-alt', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    // {
